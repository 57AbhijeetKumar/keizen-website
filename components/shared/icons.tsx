// lucide-react v1 dropped all brand/social icons (LinkedIn, Facebook, etc.) —
// minimal inline glyphs for the ones the site actually links to, added here as needed.
